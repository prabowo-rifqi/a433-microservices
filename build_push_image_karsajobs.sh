...
docker tag $GITHUB_USERNAME/karsajobs:latest ghcr.io/$GITHUB_USERNAME/a433-microservices/karsajobs:latest
...
docker push ghcr.io/$GITHUB_USERNAME/a433-microservices/karsajobs:latest